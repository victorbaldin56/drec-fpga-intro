// Single-cycle RV32I CPU top with parameterized instruction memory.
// Exposes a raw MMIO port for external peripheral connection.

module cpu_top #(
    parameter        IMEM_FILE       = "",
    parameter        IMEM_ADDR_WIDTH = 8,
    parameter        DMEM_ADDR_WIDTH = 8,
    parameter [29:0] XBAR_MMIO_START = 30'h0000,
    parameter [29:0] XBAR_MMIO_LIMIT = 30'h03FF,
    parameter [29:0] XBAR_DATA_START = 30'h0400,
    parameter [29:0] XBAR_DATA_LIMIT = 30'h3FFF
)(
    input  wire        clk,
    input  wire        rst_n,
